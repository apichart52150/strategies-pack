...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="{{asset('public/assets/images/favicon.icon')}}">
                        ...
                        <div class="message-box">
                            ...
                            <div class="buttons-con">
                                <div class="action-link-wrap">
                                    ...
                                    <a href="{{route('studentlogin')}}" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Go to Home Page</a>
                                </div>
                            </div>
                        </div>
                    </div>
